...
void Chams::RenderHistoryChams(int index) {
	...
	if (enemy && g_menu.main.players.chams_enemy_history_enable.get()) {
		...
		case 4:
			...
			break;
		case 5:
			SetupMaterial(skeet, color, true, g_menu.main.players.chams_enemy_history_wireframe.get());
			break;
		case 6:
			SetupMaterial(onetap, color, true, g_menu.main.players.chams_enemy_history_wireframe.get());
			break;
		case 7:
			SetupMaterial(yeti, color, true, g_menu.main.players.chams_enemy_history_wireframe.get());
			break;
