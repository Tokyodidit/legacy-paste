...
void Client::DrawHUD() {
	...
	std::string text = tfm::format(XOR("project one | Dev: " __DATE__ " | latency: %i ms"), ms);
...
void Client::ClanTag()
{
	...
	if (g_menu.main.misc.clantag.get()) {
		...
		if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.6) % 14) {
			...
			case 1: {  SetClanTag("P"); break; }
			case 2: {  SetClanTag("Pr"); break; }
			case 3: {  SetClanTag("Pro"); break; }
			case 4: {  SetClanTag("Proj"); break; }
			case 5: {  SetClanTag("Proje"); break; }
			case 6: {  SetClanTag("Projec"); break; }
			case 7: {  SetClanTag("Project"); break; }
			case 8: {  SetClanTag("Project"); break; }
			case 9: {  SetClanTag("o"); break; }
			case 10: { SetClanTag("on"); break; }
			case 11: { SetClanTag("one"); break; }
			case 12: { SetClanTag("one"); break; }
			case 13: { SetClanTag("on");	break; }
			case 14: { SetClanTag("o");	break; }
			case 15: { SetClanTag("");	break; }
			case 16: { SetClanTag("<3");	break; }
