...
public:
	void init() {
		...
		chams_enemy_mat.setup(XOR("Enemy chams material"), XOR("chams_enemy_mat"), { XOR("default"), XOR("flat"), XOR("metallic"), XOR("outline"), XOR("ghost"), XOR("skeet"), XOR("onetap"), XOR("yeti")});
		...
		chams_enemy_history_mat.setup(XOR("Backtrack chams material"), XOR("chams_enemy_history_mat"), { XOR("default"), XOR("flat"), XOR("metallic"), XOR("outline"), XOR("ghost"), XOR("skeet"), XOR("onetap"), XOR("yeti") });
		...
		chams_friendly_mat.setup(XOR("Teammate chams material"), XOR("chams_friendly_mat"), { XOR("default"), XOR("flat"), XOR("metallic"), XOR("outline"), XOR("ghost"), XOR("skeet"), XOR("onetap"), XOR("yeti") });
		...
		chams_local_mat.setup(XOR("Local chams material"), XOR("chams_local_mat"), { XOR("Default"), XOR("Flat"), XOR("Metallic"), XOR("Outline"), XOR("Ghost"), XOR("skeet"), XOR("onetap"), XOR("yeti") });
...
public:
	void init() {
		...
		cripwalk.setup(XOR("Retardwalk"), XOR("Cwalk"));
...
public:
	void init() {
		...
		g_gui.RegisterForm(&main, VK_DELETE);
	}
};
