...
namespace render {
	...
	extern Font indicatorss;
	extern Font logevent;
	extern Font damage;
	extern Font menuicon;
	extern Font arrows;
	...
	void DrawColoredCircle(int x, int y, int angle, Color color);
	void DrawFilledCircle(int centerx, int centery, float radius, Color color);
